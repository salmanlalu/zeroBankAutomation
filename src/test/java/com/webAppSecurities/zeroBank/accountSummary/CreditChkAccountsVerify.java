...
public class CreditChkAccountsVerify extends testBase {

	@Test(dataProvider = "accountSummaryDP", dataProviderClass = DataProviders.class)
	public static void creditchkaccountsverify(Hashtable<String, String> data) throws AssertionError {

		DataUtil.checkExecutionSuite("AccountSummarySuite", "CreditChkAccountsVerify", data.get("RunMode"));

		try {
			
			testUtil.logIn(data.get("Username"), data.get("Password"));

			click("checkingBtn_XPATH");
