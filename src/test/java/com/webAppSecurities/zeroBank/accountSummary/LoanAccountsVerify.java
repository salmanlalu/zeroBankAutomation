...
public class LoanAccountsVerify extends testBase {

	@Test(dataProvider = "accountSummaryDP", dataProviderClass = DataProviders.class)
	public static void loanaccountsverify(Hashtable<String, String> data) throws AssertionError {

		DataUtil.checkExecutionSuite("AccountSummarySuite", "LoanAccountsVerify", data.get("RunMode"));
